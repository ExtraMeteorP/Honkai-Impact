...
public class ParticleGhostFire extends SpriteTexturedParticle {

    protected ParticleGhostFire(World world, double x, double y, double z, Vec3d speed, Color color, float diameter) {
