...
/**
public class ParticleDataGhostFire implements IParticleData {

    private Vec3d speed;
    private Color color;
    private float diameter;
    public static final IDeserializer<ParticleDataGhostFire> DESERIALIZER = new IDeserializer<ParticleDataGhostFire>() {

        @Override
        public ParticleDataGhostFire deserialize(ParticleType<ParticleDataGhostFire> particleTypeIn, StringReader reader) throws CommandSyntaxException {
            ...
            return new ParticleDataGhostFire(new Vec3d(speedX, speedY, speedZ), new Color(red, green, blue, alpha), diameter);
        }

        @Override
        public ParticleDataGhostFire read(ParticleType<ParticleDataGhostFire> particleTypeIn, PacketBuffer buffer) {
            final int MIN_COLOUR = 0;
            final int MAX_COLOUR = 255;
    ...
    public ParticleDataGhostFire(Vec3d speed, Color color, float diameter) {
        this.speed = speed;
        this.color = color;
    ...
    public ParticleType<?> getType() {
        return ParticleRegistry.ghostfireParticle.get();
    }
