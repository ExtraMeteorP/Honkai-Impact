...
import com.meteor.honkaiimpact.common.entities.EntityKeyOfTruth;
import com.meteor.honkaiimpact.common.libs.LibMisc;
import com.meteor.honkaiimpact.client.model.ModelKeyOfTruth;
...
public class RenderKeyOfTruth extends EntityRenderer<EntityKeyOfTruth> {
    ...
    @Override
    public boolean shouldRender(EntityKeyOfTruth key, ClippingHelperImpl camera, double camX, double camY, double camZ) {
        return true;
    }
