...
import com.meteor.honkaiimpact.client.model.ModelSlash;
...
public class RenderSlash extends EntityRenderer<EntitySlash> {
    ...
    private EntityModel<EntitySlash> slashModel = new ModelSlash();
    ...
    @Override
    public boolean shouldRender(EntitySlash key, ClippingHelperImpl camera, double camX, double camY, double camZ) {
        return true;
    }
